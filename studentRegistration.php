...
<form role="form" id="stuRegForm">
   ...
   <div class="form-group">
   <!--<i class="fas fa-mobile"></i><label for="stunum" class="pl-2 font-weight-bold">Mobile number</label><small id="statusMsg3"></small><input type="number"
       class="form-control" placeholder="number" name="stunum" id="stunum">
