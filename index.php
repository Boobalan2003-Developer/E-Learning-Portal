...
?>  
    ...
    <div class="container-fluid bg-dark"> <!-- Start Course Page Banner -->
      <div class="row">
        <img src="./image/courseimg/main.jpg" alt="courses" style="height:500px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
    </div>
    ...
    <!-- Start About Section -->
    <div class="container-fluid p-4" style="background-color:pink">
      <div class="container" style="background-color:skyblue">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>FIRST DESK provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
